...
describe("Juego del Tenis", () => {
  ...
  it("deberia mostrar '30 - Love' cuando el jugador 1 anota 2 veces", () => {
    ...
    it("deberia mostrar 'Advantage for Player 2' cuando el jugador 1 anota 3 veces y el jugador 2 anota 4 veces", () => {
        ...
        juego.jugador2Anota();
        juego.jugador2Anota();
        expect(juego.obtenerScore()).toEqual("Advantage for Player 2");
    });

    it("deberia mostrar 'Game for Player 1' cuando el jugador 1 anota 5 veces y el jugador 2 anota 3 veces", () => {
        const juego = new Tenis();
        juego.jugador1Anota();
        juego.jugador1Anota();
        juego.jugador1Anota();
